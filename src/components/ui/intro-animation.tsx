            ...
            >
                ...
                >
                    <div className="text-center">
                        <p className="text-[8px] font-bold text-pink-400 uppercase tracking-widest mb-1">View</p>
                        <p className="text-xs font-medium text-white">Love</p>
                    </div>
                </div>
            </motion.div>
        </motion.div>
...
export default function IntroAnimation() {
    ...
    return (
        <div ref={containerRef} className="relative w-full h-screen bg-[#111111] overflow-hidden">
            {/* Container */}
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                ...
                <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2">
                    <motion.h1
                        ...
                        className="text-4xl font-serif tracking-tight text-white md:text-6xl"
                    >
                        Our Love Story.
                    </motion.h1>
                    <motion.p
                ...
                >
                    ...
                    <p className="text-sm md:text-base text-gray-400 max-w-lg leading-relaxed">
                        ...
                        Scroll through these moments we cherish forever.
                    </p>
                </motion.div>
